...
| --- | --- |
| [TechSpec.md](TechSpec.md) | Storage/artifact implementation |
| [API.md](API.md) | Endpoints touching prediction history |
| [SecurityAndCompliance.md](SecurityAndCompliance.md) | PII handling rules |
| [PRD.md](../product/PRD.md) | REQ-011 dataset lifecycle |
