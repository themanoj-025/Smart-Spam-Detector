...
|---|---|
| PRD.md | User stories behind each screen |
| Design.md | Components used by SCR-001..005 |
| API.md | Endpoints backing these flows |
| TechSpec.md | Architecture implementing the flows |
| Schema.md | History record model |
