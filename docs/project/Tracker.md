...
```mermaid
pie
    title Tasks Remaining by Phase
    "Phase 0" : 2
    "Phase 1" : 5
    "Phase 2" : 3
    "Phase 3" : 3
...
| --- | --- |
| [ImplementationPlan.md](ImplementationPlan.md) | Source of every task above |
| [PRD.md](../product/PRD.md) | Feature priorities to unblock |
| [RiskRegister.md](RiskRegister.md) | Open risks affecting schedule |
