...
1. **R-07 Artifact version skew** — enforced via sha256 manifests (see ../technical/Schema.md TBL-artifact).
...
|---|---|
|[PRD.md](../product/PRD.md)|Summarizes top risks (Section 10)|
|[SecurityAndCompliance.md](../technical/SecurityAndCompliance.md)|Security risks detail|
|[TechSpec.md](../technical/TechSpec.md)|Technical risk mitigations|
|[Tracker.md](Tracker.md)|Risk status updates|
