...
|---|---|
| PRD.md | Requirements and metrics this spec implements |
| Schema.md | Data model for datasets/artifacts/history |
| API.md | Exact endpoint contracts for `api.py` |
| ImplementationPlan.md | Tasks mapping to components above |
| Testing.md | How each component is tested |
| Deployment.md | Docker/compose deployment topology |
| SecurityAndCompliance.md | Threat model for the API surface |
