...
| US-002 | Integration engineer | To POST a message to `/predict` and get JSON | I can wire filtering into my app | P0 | API returns `{label, score}`; documented in API.md |
...
Top risks summarized from RiskRegister.md:
...
- [ ] API.md, Testing.md, Deployment.md in sync with implementation
...
|---|---|
| TechSpec.md | Architecture and stack for the classifier and API |
| AppFlow.md | Screens and user journeys for UI + API flows |
| Design.md | Visual system for the Streamlit UI |
| Schema.md | Data model for datasets, artifacts, and history |
| ImplementationPlan.md | Phased build plan mapping to REQ IDs |
| Tracker.md | Live status of every feature/task |
| Rules.md | Coding standards and AI-agent operating rules |
| API.md | Every endpoint contract |
| SecurityAndCompliance.md | Threat model and data protection |
| Testing.md | Test strategy and coverage targets |
| Deployment.md | Environments and CI/CD |
| Glossary.md | Shared vocabulary |
| RiskRegister.md | Full risk register |
