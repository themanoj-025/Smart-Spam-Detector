...
class HistoryManager:
    ...
    def get_history(
        ...
        query = """
            ...
            LIMIT ? OFFSET ?
        """.format(where_clause)  # nosec B608 - where_clause is built from fixed condition strings; values are parameterized
    ...
    def clear_history(self, days_back: int | None = None) -> int:
    ...
    def get_entry_by_id(self, record_id: int) -> dict[str, Any] | None:
