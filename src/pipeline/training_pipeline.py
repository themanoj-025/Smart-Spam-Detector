...
class TrainingPipeline:
    ...
    def run_pipeline(self) -> TrainingState:
        ...
        try:
            ...
            logger.info(f"✓ Data loaded: {self.state.training_data.shape[0]} emails, "
            ...
            logger.info(f"Best Accuracy: {self.state.model_metrics[self.state.best_model_name]['accuracy']:.4f}")
